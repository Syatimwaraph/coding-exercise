    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/hgrgomadashboard","/registerpatienthgrgoma","/transfer/").hasRole("HGR-GOMA")
                        .requestMatchers("/hgrgoma").authenticated()
                        .requestMatchers("/patientsHgrGoma").authenticated()
                        .requestMatchers("/healafricadashboard").hasRole("HEAL-AFRICA")
                        .requestMatchers("/registerpatienthealafrica").hasRole("HEAL-AFRICA")
                        .requestMatchers("/registerpatient/healafrica").authenticated()
