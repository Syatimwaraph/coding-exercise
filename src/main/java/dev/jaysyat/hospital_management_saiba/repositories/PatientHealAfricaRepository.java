...
public interface PatientHealAfricaRepository extends JpaRepository<PatientHealAfrica, Long> {
    List<PatientHealAfrica> findAllByIstransferredIsFalse();
    List<PatientHealAfrica> findAllByIstransferredIsTrue();
}
